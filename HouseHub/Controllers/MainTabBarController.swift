...
final class MainTabBarController: UITabBarController {
    ...
    private func setupViewControllers() {
        ...
        let emptyVC1 = WebViewController(websiteLink: Constants.websiteLink)
        ...
        let emptyVC2 = WebViewController(websiteLink: Constants.websiteLink)
        ...
        let emptyVC3 = WebViewController(websiteLink: Constants.websiteLink)
        ...
        let emptyVC4 = WebViewController(websiteLink: Constants.websiteLink)
